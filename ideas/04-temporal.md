...
When the model generates text, you're watching it _move_ through ideaspace in real-time.
...
- You could _draw_ a trajectory on the graph and ask: "What text would take this path?"
- You could _sketch_ a spectrogram pattern and generate text that matches it.
...
_Watch the thought move. See where it's been. Guide where it goes._
